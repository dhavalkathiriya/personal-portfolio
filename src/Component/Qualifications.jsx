                ...
                <div className="qualification_sections sm:grid sm:grid-cols-[.6fr] md:grid-cols-[.fr] sm:justify-center">
                    <div className="qualification_content">
                        ...
                        <div className="qualification_data grid grid-cols-[1fr,max-content,1fr] gap-x-[1.5rem]">
                            <div>
                                <h3 className="qualification_title text-[0.938rem] font-medium] dark:text-white">Master of Computer Appilication</h3>
                                <span className="qualification_subtitle inline-block text-[.813rem] mb-[1rem] dark:text-[#bcbac4]">Parul University, Baroda</span>
                        ...
                        <div className="qualification_data grid grid-cols-[1fr,max-content,1fr] gap-x-[1.5rem]">
                            ...
                            <div>
                                <h3 className="qualification_title text-[0.938rem] font-medium] dark:text-white">Bachloer of Business Administration</h3>
                                <span className="qualification_subtitle inline-block text-[.813rem] mb-[1rem] dark:text-[#bcbac4]">Gujarat University</span>
                                <div className="qualification_calender flex items-center text-[.75rem] text-[#a19fad] gap-1">
                                    <LuCalendarDays />
                                    2019 - 2022
                                </div>
                        ...
                        <div className="qualification_data grid grid-cols-[1fr,max-content,1fr] gap-x-[1.5rem]">
                            <div>
                                ...
                                <span className="qualification_subtitle inline-block text-[.813rem] mb-[1rem] dark:text-[#bcbac4]">Shree Aastha School,Jasdan</span>
                                <div className="qualification_calender flex items-center text-[.75rem] text-[#a19fad] gap-1">
                                    <LuCalendarDays />
                                    2017 - 2019
                                </div>
