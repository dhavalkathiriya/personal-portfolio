            ...
            <div className="footer_bg md:pt-[3rem] md:px-0 md:pb-[5rem] dark:bg-[#000000] bg-[#9234ea] pt-[2rem] px-0 pb-[3rem]">
                <div className="footer_container lg:p-0 md:py-0 md:px-[1rem] sm:grid-cols-[repeat(2,1fr)] md:grid-cols-[repeat(3,1fr)] max-w-[768px] mx-[1.5rem] grid gap-y-[3.5rem] gap-[1.5rem] lg:mx-auto lg:max-w-5xl">
                    <div className='lg:flex lg:flex-col lg:gap-3'>
                        <h1 className="footer_title text-white text-[1.5rem] mb-[0.25rem]">Dhaval</h1>
                        <h1 className="footer_title text-white text-[1.5rem] mb-[0.25rem]">Kathiriya</h1>
                        <span className="footer_subtitle text-white text-[.813rem]"> Mern Stack Developer</span>
                    </div>
                    ...
                    <div className='footer_socials flex items-center md:items-start md:justify-end'>
                        <NavLink to='https://github.com/dhavalkathiriya' target='_blank' className='text-[1.25rem] mr-[1.5rem] text-white hover:text-[#ce9dfb]'>
                            <LuGithub />
                        </NavLink>
                        <NavLink to='https://www.linkedin.com/in/dhaval-kathiriya-b63543dk/' target='_blank' className='text-[1.25rem] mr-[1.5rem] text-white hover:text-[#ce9dfb]'>
                            <FiLinkedin />
                        </NavLink>
                        <NavLink to='#' target='_blank' className='text-[1.25rem] mr-[1.5rem] text-white hover:text-[#ce9dfb]'>
                            <FiTwitter />
                        </NavLink>
                    </div>
                </div>
